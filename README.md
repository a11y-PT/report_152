---
website: "Inframoura - Empresa de Infraestruturas de Vilamoura E.M."          # Entre as aspas escreve o nome do website
date: "17/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://inframoura.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://inframoura.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Inframoura"         # Entre as aspas escrever o nome do owner do website
